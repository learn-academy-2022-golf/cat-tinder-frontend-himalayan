  ...
  return (
    <>
      <div style={{ backgroundColor: 'grey' }}>
        <h1>Guinea Pigs of The World</h1> 
      ...
      <div>
        <Navbar {...args}>
          <NavbarBrand href="/">Guinea Pigs of The World</NavbarBrand>
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="me-auto" navbar>
              ...
              <NavItem>
                <NavLink href="/PigShow/">Pig Show</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/PigNew/">Pig New</NavLink>
              </NavItem>
              <NavItem>
